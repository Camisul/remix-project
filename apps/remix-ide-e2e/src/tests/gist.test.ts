...
module.exports = {
  ...
  UploadToGists: function (browser: NightwatchBrowser) {
    ...
    browser
      ...
      .pause(1000)
      .waitForElementVisible('*[data-id="treeViewLitreeVtreeViewLitreeViewItemworkspace_1iewItembrowser/blank"]')
      ...
      .getText('[data-id="browserModalDialogModalBody-react"]', (result) => {
        ...
        if (!id) {
          ...
          browser
            ...
            .waitForElementVisible(`[data-id="treeViewLitreeViewItemworkspace_1/gists/${gistid}"]`)
            .click(`[data-id="treeViewLitreeViewItemworkspace_1/gists/${gistid}"]`)
